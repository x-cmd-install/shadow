...
合计: **54,610** 行代码（覆盖前 5 种语言、共 **497** 个文件）。
...
- **Star**: 398 · **Fork**: 287 · **开放 issue**: 499 · **贡献者**: 201

## 累计统计

- **发布数**: 58 · **已合并 PR**: 1024 · **开放 PR**: 73 · **已关闭 issue**: 407 · **开放 issue**: 92 · **提交数**: 4716
...
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/shadow.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260916.yml` · 2026-09-16T06:47:03Z._
